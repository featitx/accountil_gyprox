...
const Lots = ({ setOpen, setCurrentId, clients }) => {
...
const headerStyle = { borderBottom: 'none', textAlign: 'center'}
  ...
  return (
    ...
    <Container style={{width: '85%'}}>
      ...
      <TableHead>
          <TableRow>
            <TableCell style={{...headerStyle, width: '10px'}}>LOT Number</TableCell>
            <TableCell style={headerStyle}>Item Name</TableCell>
            <TableCell style={headerStyle}>CHO Email</TableCell>
            <TableCell style={headerStyle}>Transport</TableCell>
